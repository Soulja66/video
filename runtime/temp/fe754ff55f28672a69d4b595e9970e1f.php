<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\WWW\video\public/../application/admins\view\slide\index.html";i:1534728056;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    function add(id) {
        layer.open({
            ...
            shade: 0.3,
            area: ['480px', '420px'],
            content: '/admins.php/admins/slide/add_first?id='+id //iframe的url
        });
    }
